package com.cs.blogger.Activities.Courses;
...
public class UploadCourseStructure extends AppCompatActivity {
        ...
        msubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mStorageTask != null && mStorageTask.isInProgress()) {
                    Toast.makeText(UploadCourseStructure.this, "Upload in Progress!", Toast.LENGTH_SHORT).show();
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(UploadCourseStructure.this, "Upload Successful!", Toast.LENGTH_SHORT).show();


                           startActivity(new Intent(UploadCourseStructure.this, PostListActivity.class));
                            finish();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(UploadCourseStructure.this, e.getMessage(), Toast.LENGTH_SHORT).show();
