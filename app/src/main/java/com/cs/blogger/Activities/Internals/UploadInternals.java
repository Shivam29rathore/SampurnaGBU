...
public class UploadInternals extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.uploadinternals);
        // Using the ProcessDialog
        mProgressBar = findViewById(R.id.progressBarinternal);

        mPostimage = findViewById(R.id.addInternalfile);
        mPostTitle = findViewById(R.id.Internaltitle);
        mPostDesc = findViewById(R.id.internalDesc);
        msubmitButton = findViewById(R.id.internal_submitpost);
        ...
        mPostDatabaseRef = FirebaseDatabase.getInstance().getReference("Results").child("SOICT");
        ...
        msubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mStorageTask != null && mStorageTask.isInProgress()) {
                    Toast.makeText(UploadInternals.this, "Upload in Progress!", Toast.LENGTH_SHORT).show();
                } else {
                    startPosting();
                }
    ...
    private void startPosting() {
        ...
        if (!TextUtils.isEmpty(titleVal) && !TextUtils.isEmpty(descVal)
            ...
            final StorageReference filepath = mStorage.child("Results").child("SOICT");
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(UploadInternals.this, "Upload Successful!", Toast.LENGTH_SHORT).show();


                           startActivity(new Intent(getApplicationContext(), ViewAllwork.class));
                           finish();
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(UploadInternals.this, e.getMessage(), Toast.LENGTH_SHORT).show();
