...
public class AddGrievances extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_grievances);
        // Using the ProcessDialog
        mProgressBar = findViewById(R.id.progressBar2_grievances);

        mPostimage = findViewById(R.id.addImageButton_grievnces);
        mPostTitle = findViewById(R.id.postTitle_grievances);
        mPostDesc = findViewById(R.id.postDescription_grievances);
        msubmitButton = findViewById(R.id.submitPostBt_grievances);
        ...
        mPostDatabaseRef = FirebaseDatabase.getInstance().getReference("Grievances").child("Hostel");
        ...
        msubmitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (mStorageTask != null && mStorageTask.isInProgress()) {
                    Toast.makeText(AddGrievances.this, "Upload in Progress!", Toast.LENGTH_SHORT).show();
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ...
                    result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(AddGrievances.this, "Comoplaint registered!", Toast.LENGTH_SHORT).show();


                           startActivity(new Intent(AddGrievances.this,Grievances.class));
                    ...
                    .addOnFailureListener(new OnFailureListener() {
                        ...
                        public void onFailure(@NonNull Exception e) {
                            ...
                            Toast.makeText(AddGrievances.this, e.getMessage(), Toast.LENGTH_SHORT).show();
