...
public class ebookAdapter extends RecyclerView.Adapter<ebookAdapter.NoticeboardViewHolder> {

    ArrayList<ResultsHelper> results;
    Context context;


    public ebookAdapter(ArrayList<ResultsHelper> results, Context context) {
