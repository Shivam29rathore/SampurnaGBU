package com.cs.blogger.Adapters.IntroSlider;
...
public class SliderAdapter extends PagerAdapter {
    ...
    // Instiating the item and changing items for each view
    @NonNull
    @Override
    public Object instantiateItem(@NonNull ViewGroup container, int position) {

        // Asking the system to use th design
        ...
        //Setting Image, Heading and Description
