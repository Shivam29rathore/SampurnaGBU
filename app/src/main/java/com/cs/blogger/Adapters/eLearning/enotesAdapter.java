...
public class enotesAdapter extends RecyclerView.Adapter<enotesAdapter.NoticeboardViewHolder> {

    ArrayList<ResultsHelper> results;
    Context context;


    public enotesAdapter(ArrayList<ResultsHelper> results, Context context) {
